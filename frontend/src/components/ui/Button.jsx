...
import { cn } from '../../utils/cn'; // path: src/utils/cn.js
...
const Button = React.forwardRef(({ className, variant, size, leftIcon, rightIcon, loading = false, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      {/* Loading spinner */}
      {loading && (
        <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden>
