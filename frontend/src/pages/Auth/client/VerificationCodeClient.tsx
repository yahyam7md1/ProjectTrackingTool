...
const VerificationCodeClient: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await apiService.post('/auth/client/verify-code', {
        email,
    ...
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription style={{ color: "#606060"}}>
          If you are a valid client, you will receive a 6-digit code to {email}. The code expires in 10 minutes.
        </CardDescription>
      </CardHeader>
      <CardContent>
